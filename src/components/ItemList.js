            ...
            {items.map((item) => (
                ...
                >
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        />
                        <button className="font-bold text-xl text-green-600 w-[118px] bg-slate-100 rounded-md p-1 border border-gray-300 relative bottom-3 hover:bg-slate-400">ADD</button>
                    </div>
